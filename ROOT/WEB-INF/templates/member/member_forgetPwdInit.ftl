...
<#import "./fields/field_member_forgetPwdInit_scripts.ftl" as field_member_scripts />
<#-- 导入主要内容 -->

<#import "./fields/field_member_forgetPwdInit.ftl" as field_member_forgetPwdInit  />
<#-- 导入页脚内容  -->
