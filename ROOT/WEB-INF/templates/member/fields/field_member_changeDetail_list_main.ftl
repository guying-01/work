...
<#macro render data>
    ...
    <div class="member-list-tab" >
        <h2 class="member-tit modify" onclick="javascript :history.go(-1);"> <a class="backwards" href="javascript:void(0);"></a><i>&nbsp;</i><span>变动明细</span></h2>
        <div class="bk_change_main">
            ...
            <div class="order-serch">
                <div>
                <span>开始时间：</span><input readonly="" style="margin-left: 0.3rem;position: relative" class=" text_A laydate-icon dm-no-auto-clear" id="startDate" name="startDate"><div style="clear: both"></div>
                </div>
                <div style="margin-top: 0.1rem;">
                <span>结束时间：</span><input readonly="" style="margin-left: 0.3rem;position: relative" class=" text_A laydate-icon dm-no-auto-clear" id="endDate" name="endDate"><div style="clear: both"></div>
                </div>
