        ...
        <div class="information-into">
          ...
          <div class="information-line">
            ...
            <#list smCashAccountFormList as item>
              <input id="tempAccount" name="tempAccount" type="text" class="text_A required" disabled="disabled" value="${item.accountName}"/>
            </#list>
          ...
          <div class="information-line">
            ...
            <a href="javascript:void(0);" <#--id="sendSmsVerificationCodeBtn"--> class="small-button" style="background: #ddd;border: 0">发送验证码</a>
          ...
          <div class="bottom-button">
            <a href="javascript:void(0);" <#--id="submitBtn"--> class="big-button" style="background: #ddd">提现</a>
          </div>
        </div>
      </form>
    </div>
