...
<#escape x as x?html>
    ...
    <div class="member-con">
      <h2 class="member-tit mobileHistory"  onclick="javascript :history.go(-1);"><a href="javascript:void(0);"></a><i>&nbsp;</i>浏览历史</h2>
          ...
          <div class="footprintDate">
			...
			{{#each data}}
      		<li class="member-list-history"><a href="/fsgd/{{goodsId}}.jhtml" class="goods_pic"><img dm-actor="browse-history-item-pic" dm-data="{{goodsId}}" src="{{goodsPicturePath}}" width="400" height="400" class="goodspic"></a>
      			<h4><a href="/fsgd/{{goodsId}}.jhtml" class="produce his_gsName" title="{{goodsName}}">{{goodsName}}</a></h4><P class="goodsprice his_gdPrice" id="foodprice"><strong>￥{{saleMinPrice}}</strong><#--<span style="color: #A0A0A0;float:right">￥{{marketMinPrice}}</span>--></p>
