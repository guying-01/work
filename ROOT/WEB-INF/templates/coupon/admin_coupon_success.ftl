...
<#-- 导入主要内容 -->
<#import "./fields/field_admin_coupon_success_info.ftl" as field_admin_coupon_success_info />

<#-- 导入页脚内容  -->

<#-- 调用通用模板 [ 标题  | metas | 链接  | 脚本  | 主要内容  | 页脚  | 数据  ]-->
<@common_template.render "优惠券-领取成功",[],[field_coupon_common_links],[field_coupon_common_scripts],[field_admin_coupon_success_info],[],data?? />