<#--二级类目页:海鲜类_活鲜鱼 ID:307_00000000000000240_gic-->
	...
	<head lang="en">
		...
		<#include "/basepage/store/default/hb_templates/categorypic_hb_templates.ftl" />
		...
		<@script.render />
		<!--导入共通脚本-->
		<link rel="stylesheet" href="${resources}/basepage/store/default/category_navigation/css/category_pic.css" type="text/css">
        <script type="text/javascript" src="${resources}/basepage/store/default/category_navigation/js/category_data.js"></script>
		<script type="text/javascript" src="${resources}/basepage/store/default/category_navigation/js/categorypic_dynamics.js"></script>
		<script type="text/javascript">
			$(function() {
				var deviceWidth = document.documentElement.clientWidth;	
				if(deviceWidth>768){
				...
				$(".category-viewport").height(deviceHeight-$(".category_search_box").height()-$(".footer-tab").height()-$(".header_box ul li").height());
				...
				$('.tab-item2').css('color', '#c91622').siblings().css('color', '#696969');
                $('.tab-item2 i').css({
                	'background': 'url(${resources}/basepage/store/default/common_img/tab-icon2R.png) no-repeat center center',
	...
	<body>
		...
		<div class="category-viewport">
			...
			<div class="page_yiji_wrap" style="width: 80%">
				<ul class="page_yiji_title_b scrollbar-none">
				</ul>
			</div>
		</div>
