...
<html>
	...
	<@link.render />
		...
		<link rel="stylesheet" href="${resources}/basepage/store/default/list_pages/css/list_pages.css" type="text/css">
    ...
    <script src="${resources}/basepage/store/default/list_pages/js/search_dynamics.js?v20170428"></script>
    <#--<script src="${resources}/basepage/store/default/list_pages/js/erji.js" type="text/javascript" charset="utf-8"></script>-->
    <script src="${resources}/basepage/store/default/list_pages/js/slidenav_active.js" type="text/javascript"></script>
	...
	<body>
	<@scrollTop.render/>
		<div id="pageInfo" currentPageRes="${resources!""}" keyword="${keyword!""}" storeId="${storeId!''}" isOrderByContractNo="${isOrderByContractNo!''}" style="display: none"></div>
		<!--页面信息-->
    ...
    <#--导入header_top-->
      ...
      <#--<div id="category">
          <div class="nav_bread my_clear">
              <a href="/">首页</a><i></i><a href="javascript:void(0);">搜索全部</a><i></i><span>${keyword!""}</span>
          </div>
    </div>-->
			<!--此处是类别结束-->
      ...
      <div class="line"></div>
		<div class="contentRight-ListWrap_box">
			<div id="contentRight-ListWrap">
				<div id="contentRight-ListWrap-ads"><!--此处通过id="list_goodsList_ads"模板加载--></div>
				<div id="contentRight-ListWrap-main"><!--此处通过id="list_goodsList_main"模板加载--></div>
			</div>
		</div>
		<div class="orderMoreBox"">
            <div class="orderMore">点击加载更多</div>
		</div>
      <#--</div>-->
			<!--热卖推荐结束-->
