<#--一级类目页:熟食类 ID:307_00000000000000997_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--牛肉熟食 / 羊肉熟食开始-->
        <div class="fl_box fl_2">
            <p class="fl_title">2F 牛肉熟食 / 羊肉熟食</p>
            <div class="my_clear">
                <div class="left">
    ...
    <#--鸡肉熟食 / 鸭肉熟食 / 鹅肉熟食开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 鸡肉熟食 / 鸭肉熟食 / 鹅肉熟食</p>
            <div class="my_clear">
    ...
    <#--肠类熟食结束-->
    <#--蛋类熟食 / 丸子熟食 / 鱼类熟食 / 蔬菜熟食开始-->
        <div class="fl_box fl_7">
            <p class="fl_title">7F 蛋类熟食 / 丸子熟食 / 鱼类熟食 / 蔬菜熟食</p>
            <div class="my_clear">
    ...
    <#--蛋类熟食 / 丸子熟食 / 鱼类熟食 / 蔬菜熟食结束-->
    <#--熟食皮冻 / 豆制品熟食 / 熟食下货 / 其他开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 熟食皮冻 / 豆制品熟食 / 熟食下货 / 其他</p>
            <div class="my_clear">
