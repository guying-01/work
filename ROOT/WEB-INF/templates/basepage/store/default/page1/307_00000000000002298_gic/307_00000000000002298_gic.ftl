<#--一级类目页:调料、调味品 ID:307_00000000000002298_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="fl_box fl_1">
            <p class="fl_title">1F 酱油、糖醋盐、味精</p>
            <div class="my_clear">
    ...
    <#--粉 、 面 、 颗粒 、 晶体类开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 粉 、 面 、 颗粒 、 晶体类</p>
            <div class="my_clear">
    ...
    <#--天然香辛料和辣椒开始-->
        <div class="fl_box fl_4">
            <p class="fl_title">4F 天然香辛料和辣椒 / 果酱、果汁、沙拉类</p>
            <div class="my_clear">
    ...
    <#--酱品类 / 腌料类 / 底料和蘸料开始-->
        <div class="fl_box fl_5">
            <p class="fl_title">5F 调味酱 / 腌料类、底料和蘸料</p>
            <div class="my_clear">
    ...
    <#--油脂类 / 膏状 、 流体 、 汤类开始-->
        <div class="fl_box fl_6">
            <p class="fl_title">6F 调味油、油脂乳品 / 膏状、流体、汤类</p>
            <div class="my_clear">
    ...
    <#--馅料类 / 罐头调料类开始-->
        <div class="fl_box fl_7">
            <p class="fl_title">7F 馅料类 / 罐头及袋装类 / 烘焙原辅料</p>
            <div class="my_clear">
    ...
    <#--西餐日韩餐调料类开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 西餐日韩餐调料类 / 早餐食品</p>
            <div class="my_clear">
