<#--一级类目页:厨房设备及厨具 ID:307_00000000000005895_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <!--展会结束-->
        <!--灶具炉具设备 / 排烟通风设备 / 调理设备 / 机械类设备开始-->
        <div class="fl_box fl_1">
            <p class="fl_title">1F 灶具炉具设备 / 排烟通风设备 / 调理设备 / 机械类设备</p>
            <div class="my_clear">
        ...
        <!--灶具炉具设备 / 排烟通风设备 / 调理设备 / 机械类设备结束-->
    <#--电器设备 / 厨房监控设备 / 洗涤设备 / 消毒设备开始-->
        <div class="fl_box fl_2">
            <p class="fl_title">2F 电器设备 / 厨房监控设备 / 洗涤设备 / 消毒设备</p>
            <div class="my_clear">
                <div class="left">
    ...
    <#--电器设备 / 厨房监控设备 / 洗涤设备 / 消毒设备结束-->
    <#--烹饪锅具 / 炒锅勺铲笊篱 / 方盘码斗 / 烧腊针叉勾开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 烹饪锅具 / 炒锅勺铲笊篱 / 方盘码斗 / 烧腊针叉勾</p>
            <div class="my_clear">
    ...
    <#--烹饪锅具 / 炒锅勺铲笊篱 / 方盘码斗 / 烧腊针叉勾结束-->
    <#--烘焙 / 烧烤 / 自助餐系列开始-->
        <div class="fl_box fl_4">
            <p class="fl_title">4F 烘焙 / 烧烤 / 自助餐系列</p>
            <div class="my_clear">
    ...
    <#--面案用具 / 秤 / 刀具 / 砧板 / 盆钵开始-->
        <div class="fl_box fl_5">
            <p class="fl_title">5F 面案用具 / 秤 / 刀具 / 砧板 / 盆钵</p>
            <div class="my_clear">
    ...
    <#--炉具配件 / 叉子剪刀 / 杂件 / 模具 / 桶开始-->
        <div class="fl_box fl_6">
            <p class="fl_title">6F 炉具配件 / 叉子剪刀 / 杂件 / 模具 / 桶</p>
            <div class="my_clear">
    ...
    <#--海鲜保鲜盒 / 调味器皿 / 厨房耗材开始-->
        <div class="fl_box fl_7">
            <p class="fl_title">7F 海鲜保鲜盒 / 调味器皿 / 厨房耗材</p>
            <div class="my_clear">
    ...
    <#--加热保温 / 制冷保温设备开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 加热保温 / 制冷保温设备</p>
            <div class="my_clear">
