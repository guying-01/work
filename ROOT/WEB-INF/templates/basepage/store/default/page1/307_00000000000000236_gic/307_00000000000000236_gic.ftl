<#--一级类目页:酒店专业装修 ID:307_00000000000000236_gic-->
...
<#--    <script type="text/javascript" src="${resources}/basepage/store/default/level_pages/js/fflv1_js/lv1_dynamics.js"></script><!--此处是动态数据绑定函数&ndash;&gt;-->
...
<#--    <div class="title">酒店专业装修</div>-->
    ...
    <div>
        <div class="item_list"><#--地面-->
            <ul class="pd">
                <li class="item">
                    <a href="/fsst/101_00000000000000391_str/top.jhtml">
                        <div class="brand_name">大连圣广机电安装工程有限公司</div>
                        <div class="in_box my_clear">
                            <img src="${resources}/basepage/store/default/level_pages/img/fflv1_img/service/service_sg.jpg">
                            <div>业务领域：酒店装修/家装工程/工装工程/DIY自选装修</div>
                        </div>
                        <p>进入商铺</p>
                    </a>
                </li>
                <li class="item">
                    <a href="/fsst/101_00000000000000389_str/top.jhtml">
                        <div class="brand_name">金蜜蜂装饰装修</div>
                        <div class="in_box my_clear">
                            <img src="${resources}/basepage/store/default/level_pages/img/fflv1_img/service/service_zl.jpg">
                            <div>业务领域:  室内外装修设计 住宅及大型公用建筑设计、施工等</div>
                        </div>
                        <p>进入商铺</p>
                    </a>
                </li>
