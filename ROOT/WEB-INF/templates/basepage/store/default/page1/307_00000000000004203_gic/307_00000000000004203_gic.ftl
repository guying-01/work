<#--一级类目页:酒水饮料 ID:307_00000000000004203_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--黄酒 / 养生酒 / 药酒开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 黄酒 / 养生酒 / 药酒</p>
            <div class="my_clear">
    ...
    <#--饮料开始-->
        <div class="fl_box fl_7">
            <p class="fl_title">7F 饮料 / 餐饮专用饮料</p>
            <div class="my_clear">
