<#--一级类目页:办公设备及用品 ID:307_00000000000001166_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <!--展会结束-->
        <!--书写用品 / 笔记本 / 办公纸张 / 办公耗材 / 会议用品开始-->
        <div class="fl_box fl_1">
            <p class="fl_title">1F 书写用品 / 笔记本 / 办公纸张 / 办公耗材 / 会议用品</p>
            <div class="my_clear">
        ...
        <!--书写用品 / 笔记本 / 办公纸张 / 办公耗材 / 会议用品结束-->
    <#--包装用品开始-->
        <div class="fl_box fl_2">
            <p class="fl_title">2F 包装用品</p>
            <div class="my_clear">
                <div class="left">
    ...
    <#--文件管理用品 / 财会档案用品开始-->
        <div class="fl_box fl_4">
            <p class="fl_title">4F 文件管理用品 / 财会档案用品</p>
            <div class="my_clear">
