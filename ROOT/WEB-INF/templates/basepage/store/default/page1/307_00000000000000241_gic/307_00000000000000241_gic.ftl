<#--一级类目页:餐具及前厅用品 ID:307_00000000000000241_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="story_box">
            ...
            <div class="story my_clear">
                <div>
                    <a href="/others/comingSoon_3th.jhtml"><a href="/others/comingSoon_3th.jhtml"><img src="${resources}/basepage/store/default/level_pages/img/fflv1_img/ff_story01.jpg"></a>
                        <p>企业新闻报道</p></a>
                </div>
                <div>
        ...
        <!--展会结束-->
        <!--碗碟盘 / 果盘果篮 / 石锅石板 / 锅仔明炉 / 摆台盘开始-->
        <div class="fl_box fl_1">
            <p class="fl_title">1F 碗碟盘 / 果盘果篮 / 石锅石板 / 锅仔明炉 / 摆台盘</p>
            <div class="my_clear">
        ...
        <!--碗碟盘 / 果盘果篮 / 石锅石板 / 锅仔明炉 / 摆台盘结束-->
    <#--筷子 / 刀叉勺 / 筐篮盛器 / 笼屉 / 砂煲 / 铁板开始-->
        <div class="fl_box fl_2">
            <p class="fl_title">2F 筷子 / 刀叉勺 / 筐篮盛器 / 笼屉 / 砂煲 / 铁板</p>
            <div class="my_clear">
                <div class="left">
    ...
    <#--筷子 / 刀叉勺 / 筐篮盛器 / 笼屉 / 砂煲 / 铁板结束-->
    <#--水具 / 酒具 / 茶具 / 咖啡器具 / 水壶开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 水具 / 酒具 / 茶具 / 咖啡器具 / 水壶</p>
            <div class="my_clear">
    ...
    <#--水具 / 酒具 / 茶具 / 咖啡器具 / 水壶结束-->
    <#--餐车 / 备餐台 / 展柜 / 刺身盘 / 寿司料理器具开始-->
        <div class="fl_box fl_4">
            <p class="fl_title">4F 餐车 / 备餐台 / 展柜 / 刺身盘 / 寿司料理器具</p>
            <div class="my_clear">
    ...
    <#--餐车 / 备餐台 / 展柜 / 刺身盘 / 寿司料理器具结束-->
    <#--桌椅板凳 / 盘饰 / 自助餐系列开始-->
        <div class="fl_box fl_5">
            <p class="fl_title">5F 桌椅板凳 / 盘饰 / 自助餐系列</p>
            <div class="my_clear">
    ...
    <#--桌椅板凳 / 盘饰 / 自助餐系列结束-->
    <#--清洁用品 / 餐巾纸 / 打包盒 / 牙签 / 塑料袋开始-->
        <div class="fl_box fl_6">
            <p class="fl_title">6F 清洁用品 / 餐巾纸 / 打包盒 / 牙签 / 塑料袋</p>
            <div class="my_clear">
    ...
    <#--清洁用品 / 餐巾纸 / 打包盒 / 牙签 / 塑料袋结束-->
    <#--杂件类 / 钟表 / 标牌 / 调味壶 / 调味器皿开始-->
        <div class="fl_box fl_7">
            <p class="fl_title">7F 杂件类 / 钟表 / 标牌 / 调味壶 / 调味器皿</p>
            <div class="my_clear">
    ...
    <#--杂件类 / 钟表 / 标牌 / 调味壶 / 调味器皿结束-->
    <#--托盘类 / 布草类 / 异形餐具订制开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 托盘类 / 布草类 / 异形餐具订制</p>
            <div class="my_clear">
