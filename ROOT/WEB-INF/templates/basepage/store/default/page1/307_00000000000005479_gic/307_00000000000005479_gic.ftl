<#--一级类目页:装饰品及花卉 ID:307_00000000000005479_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="fl_box fl_1">
            <p class="fl_title">1F 鲜花 / 仿真花 / 绿植</p>
            <div class="my_clear">
