<#--一级类目页:海鲜类 ID:307_00000000000000237_gic-->
...
<div class="middle classification_lv1">
    ...
    <div class="middle_inbox">
        ...
        <div class="fl_box fl_2">
            ...
            <div class="my_clear">
                <div class="left">
                    ...
                    <a class="level_${level1}_f2_banner2_01 item2"><img src="${resources}/basepage/store/default/level_pages/img/fflv1_img/fl2_ads02.jpg"></a>
                </div>
                <div class="right">
        ...
        <div class="fl_box fl_4">
            <p class="fl_title">4F 活鲜螺贝类 / 冰鲜螺贝类</p>
            <div class="my_clear">
        ...
        <div class="fl_box fl_5">
            <p class="fl_title">5F 软体活鲜 / 软体冰鲜</p>
            <div class="my_clear">
        ...
        <div class="fl_box fl_6">
            <p class="fl_title">6F 鲜藻类 / 加工藻类 / 其他 / 本地小船海鲜</p>
            <div class="my_clear">
        ...
        <#--藻类结束-->
        <#--海鲜礼盒 / 海鲜加工菜 / 半加工速冻海产品开始-->
        <div class="fl_box fl_7">
            <p class="fl_title">7F 海鲜礼盒 / 海鲜加工菜 / 半加工速冻海产品</p>
            <div class="my_clear">
        ...
        <#--海鲜礼盒 / 海鲜加工菜 / 半加工速冻海产品结束-->
        <#--海鲜肉类 / 应季海鲜 / 进口海鲜 / 水发海鲜开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 海鲜肉类 / 应季海鲜 / 进口海鲜 / 水发海鲜</p>
            <div class="my_clear">
