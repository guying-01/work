...
<#list shopCartInfoFormmap?keys as mKey >
   ...
   <#--  <#assign freightitem = freightmap[mKey]> -->
    <div class="table-tit  table_bgA">
       <a class="store_info" href="/fsst/${shopCartInfoFormmapitem[0].sgGoodsForm.storeId!}/top.jhtml"> <span>商铺：</span><span class="store_word"  >${shopCartInfoFormmapitem[0].sgGoodsForm.storeName!}</span></a><#--店铺名称-->
