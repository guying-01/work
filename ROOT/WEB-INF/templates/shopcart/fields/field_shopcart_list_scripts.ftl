...
<#--<script type="text/javascript" src="${resources}/js/shopcart/bottomGoods.js"></script>-->       <#-------------用不到，防止报错------------>
...
<script type="text/javascript" src="${resources}/basepage/store/default/common_js/header_shopcar.js?v2017042601"></script>
