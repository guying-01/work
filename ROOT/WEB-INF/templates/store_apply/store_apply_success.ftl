...
<#-- 导入主要内容 -->
<#import "./fields/field_store_apply_success.ftl" as field_store_apply_success  />
<#-- 导入页脚内容  -->

<#-- 调用通用（用户中心）模板 [ 标题 | metas | 链接 | 脚本 | 主要内容  | 左侧导航栏 | 页脚 | 数据  ]-->
<@common_template.render "店铺开通成功",[],[field_store_common_links],[],[field_store_apply_success],[],data?? />
