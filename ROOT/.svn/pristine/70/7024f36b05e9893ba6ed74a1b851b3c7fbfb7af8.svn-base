...
<#import "/common/common_promotion_template.ftl" as common_template  />
<#import "/common/common_meta.ftl" as common_meta  />

<#-- 导入样式、脚本 -->
<#import "./fields/field_promotion_list_link.ftl" as field_promotion_list_link />
<#import "./fields/field_promotion_list_scripts.ftl" as field_promotion_list_scripts />

<#-- 导入主要内容 -->
<#import "./fields/field_promotion_list.ftl" as field_promotion_list />
...
<@common_template.render "营销活动推荐 - 饭饭在线",[],[field_promotion_list_link],[field_promotion_list_scripts],[field_promotion_list],[],data??/>