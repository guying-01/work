<#--一级类目页:回收类 ID:307_00000000000002238_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="fl_box fl_1">
            <p class="fl_title">1F 纸箱 / 废纸 / 塑料</p>
            <div class="my_clear">
