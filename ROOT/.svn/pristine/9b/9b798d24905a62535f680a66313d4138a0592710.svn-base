<#--一级类目页:土杂五金 ID:307_00000000000006104_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="fl_box fl_1">
            <p class="fl_title">1F 家庭装饰 / 建筑装饰/p>
            <div class="my_clear">
    ...
    <#--水暖五金 / 卫浴五金开始-->
        <div class="fl_box fl_6">
            <p class="fl_title">6F 水暖五金 / 卫浴五金</p>
            <div class="my_clear">
