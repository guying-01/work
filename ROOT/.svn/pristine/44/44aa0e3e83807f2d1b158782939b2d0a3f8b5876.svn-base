<#--一级类目页:干货类 ID:307_00000000000001644_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <!--展会结束-->
        <!--海鲜干鱼类 / 海鲜干虾类 / 海鲜干螺贝类 / 海鲜干海藻类 / 海鲜干软体类开始-->
        <div class="fl_box fl_1">
            <p class="fl_title">1F 海鲜干鱼类 / 海鲜干虾类 / 海鲜干螺贝类 / 海鲜干海藻类 / 海鲜干软体类</p>
            <div class="my_clear">
        ...
        <!--海鲜干鱼类 / 海鲜干虾类 / 海鲜干螺贝类 / 海鲜干海藻类 / 海鲜干软体类结束-->
    <#--豆制品干货开始-->
        <div class="fl_box fl_2">
            <p class="fl_title">2F 豆制品干货</p>
            <div class="my_clear">
                <div class="left">
    ...
    <#--水果干货开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 水果干货 / 淡水干鱼类</p>
            <div class="my_clear">
    ...
    <#--肉类干货开始-->
        <div class="fl_box fl_5">
            <p class="fl_title">5F 肉类干货 / 蔬菜干货及粉条</p>
            <div class="my_clear">
    ...
    <#--中药 / 高档珍品干货开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 中药 / 高档珍品干货</p>
            <div class="my_clear">
