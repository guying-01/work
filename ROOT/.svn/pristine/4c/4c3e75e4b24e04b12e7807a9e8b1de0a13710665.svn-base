<#--一级类目页:副食及小食品 ID:307_00000000000004793_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="fl_box fl_1">
            <p class="fl_title">1F 糖果 / 食糖 / 蛋糕订制</p>
            <div class="my_clear">
    ...
    <#--干果 / 坚果 / 蜜饯开始-->
        <div class="fl_box fl_5">
            <p class="fl_title">5F 干果 / 坚果 / 蜜饯</p>
            <div class="my_clear">
    ...
    <#--罐头 / 蔬菜结束-->
    <#--膨化食品 / 无糖食品 / 方便面速食 / 饼干开始-->
        <div class="fl_box fl_7">
            <p class="fl_title">7F 膨化食品 / 无糖食品 / 方便面速食 / 饼干</p>
            <div class="my_clear">
    ...
    <#--膨化食品 / 无糖食品 / 方便面速食 / 饼干结束-->
    <#--主食类速食 / 进口副食开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 主食类速食 / 进口副食</p>
            <div class="my_clear">
