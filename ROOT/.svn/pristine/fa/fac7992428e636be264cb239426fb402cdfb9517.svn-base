...
; !function(a) {
	...
	c.events = function() {
		...
		function() {
			c.elem[h.elemv] = "",
			(c.options.delFunc&&c.options.delFunc(c.opts)),//后添加的
			c.close()
		}),
