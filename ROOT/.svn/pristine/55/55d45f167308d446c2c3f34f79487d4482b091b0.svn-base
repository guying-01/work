<#--一级类目页:豆、蛋、奶及面食制品 ID:307_00000000000004784_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="fl_box fl_1">
            <p class="fl_title">1F 大豆制品 / 绿豆制品 / 混合豆制品</p>
            <div class="my_clear">
    ...
    <#--鲜蛋类 / 加工蛋类开始-->
        <div class="fl_box fl_2">
            <p class="fl_title">2F 鲜蛋类 / 加工蛋类</p>
            <div class="my_clear">
                <div class="left">
    ...
    <#--鲜蛋类 / 加工蛋类结束-->
    <#--鲜奶类 / 酸奶类 / 干奶酪类 / 乳品类 / 奶粉类 / 冰淇淋类开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 鲜奶类 / 酸奶类 / 奶酪类 / 乳品类 / 奶粉类 / 冰淇淋类</p>
            <div class="my_clear">
    ...
    <#--鲜奶类 / 酸奶类 / 干奶酪类 / 乳品类 / 奶粉类 / 冰淇淋类结束-->
    <#--面条类 / 面皮类开始-->
        <div class="fl_box fl_4">
            <p class="fl_title">4F 面条类 / 面皮类</p>
            <div class="my_clear">
    ...
    <#--进口奶类 / 其它奶类 / 其它类开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 进口奶类 / 其它奶类 / 其它类</p>
            <div class="my_clear">
