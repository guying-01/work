...
<html>
	...
	<head>
		<meta charset="utf-8" />
		<title></title>
		<link rel="stylesheet" type="text/css" href="${resources}/basepage/store/default/promotion/css/cheap.css" />
        ...
        <script src="${resources}/basepage/store/default/promotion/js/cheap.js" type="text/javascript" charset="utf-8"></script>
	...
	<body>
    <input type="hidden" requestNum="02" id="promotion-common">
	<@scrollTop.render />
		<!--此处是头部开始-->
    <div class="top">
