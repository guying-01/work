<#--一级类目页:米面粮油 ID:307_00000000000004244_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--五谷杂粮开始-->
        <div class="fl_box fl_2">
            <p class="fl_title">2F 五谷杂粮 / 糕点用油</p>
            <div class="my_clear">
                <div class="left">
    ...
    <#--食用植物油 / 食用动物油 / 食用调和油开始-->
        <div class="fl_box fl_6">
            <p class="fl_title">6F 食用植物油 / 食用动物油 / 食用调和油</p>
            <div class="my_clear">
    ...
    <#--进口米面粮油 / 其他开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 进口米面粮油 / 其他</p>
            <div class="my_clear">
