<#--一级类目页:淡水产品 ID:307_00000000000003675_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="fl_box fl_1">
            <p class="fl_title">1F 活鲜淡水鱼 / 冰鲜淡水鱼</p>
            <div class="my_clear">
    ...
    <#--淡水活虾 / 淡水冰虾开始-->
        <div class="fl_box fl_4">
            <p class="fl_title">4F 淡水活虾 / 淡水冰虾</p>
            <div class="my_clear">
    ...
    <#--活淡水两栖动物 / 冰鲜淡水两栖动物开始-->
        <div class="fl_box fl_5">
            <p class="fl_title">5F 活淡水两栖动物 / 冰鲜淡水两栖动物</p>
            <div class="my_clear">
