  ...
  <div class="wrapper cardSuccess">
    <div class="cardSuccess-con">
      ...
      <#if couponForm??>
	      ...
	      <P>使用门槛：全店满足${couponForm.money}元使用</P>
	      <#else>
	      <P>使用门槛：无条件</P>
	      </#if>
      ...
      <#if storeId??>
    	<a href="/fsst/${storeId!''}/top.jhtml" class="card-bta">进入店铺</a>
     </#if>
    <a href="javascript:void(0);" class="card-btb" onclick="$.dm.jumpTo('#')">查看优惠券</a> </div>
  </div>
</div>
</#escape>
</#macro>