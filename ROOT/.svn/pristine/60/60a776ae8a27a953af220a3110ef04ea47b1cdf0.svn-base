<#--一级类目页:餐饮信息化建设 ID:307_00000000000000297_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--8icon结束-->
        ...
        <div class="fl_box fl_1">
            <p class="fl_title">1F 收银系统 / 监控系统 / POS机系统</p>
            <div class="my_clear">
    ...
    <#--餐饮信息化硬件设备开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 餐饮信息化硬件设备</p>
            <div class="my_clear">
    ...
    <#--餐饮信息化咨询与服务开始-->
        <div class="fl_box fl_5">
            <p class="fl_title">5F 餐饮信息化咨询与服务</p>
            <div class="my_clear">
