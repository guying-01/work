      ...
      <form id="editForm">
        ...
        <div class="information-into information-into-gy">
	      ...
	      <option value='' areaid='' bankcode='' selected dm-container='select2'>请选择</option>
            ...
            <div class="information-line" id="bankCodeDiv">
          ...
          <div class="information-line">
            ...
            <div id="sendSmsAgainCountdownDiv" style="display:none;padding: 0.05rem;text-align: center">
              <div id="sendSmsAgainCountdownSecond" style="display: inline-block"></div>秒后可再次发送验证码短信
            </div>
          </div>
          <div class="information-line">
