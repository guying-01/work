<#--一级类目页:蔬菜类 ID:307_00000000000002491_gic-->
...
<div class="middle classification_lv1">
    ...
    <#--叶菜 / 白菜甘蓝芥菜类开始-->
        <div class="fl_box fl_2">
            <p class="fl_title">2F 叶菜 / 白菜甘蓝芥菜类</p>
            <div class="my_clear">
                <div class="left">
    ...
    <#--茄 、 果 、 椒类 / 荚豆类 / 瓜菜类开始-->
        <div class="fl_box fl_3">
            <p class="fl_title">3F 茄 、 果 、 椒类 / 荚豆类 / 瓜菜类</p>
            <div class="my_clear">
    ...
    <#--葱 、 姜 、 蒜开始-->
        <div class="fl_box fl_4">
            <p class="fl_title">4F 葱 、 姜 、 蒜 / 鲜花</p>
            <div class="my_clear">
    ...
    <#--虫类开始-->
        <div class="fl_box fl_6">
            <p class="fl_title">6F 虫类 / 净菜切配菜</p>
            <div class="my_clear">
    ...
    <#--芽苗类 / 鲜菇菌类开始-->
        <div class="fl_box fl_7">
            <p class="fl_title">7F 芽苗类 / 鲜菇菌类</p>
            <div class="my_clear">
    ...
    <#--应季野菜 / 进口蔬菜 / 有机蔬菜开始-->
        <div class="fl_box fl_8">
            <p class="fl_title">8F 应季野菜 / 进口蔬菜 / 有机蔬菜</p>
            <div class="my_clear">
