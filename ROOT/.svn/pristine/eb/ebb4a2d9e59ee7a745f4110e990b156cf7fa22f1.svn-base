      ...
      <ul class="detail-price">
        ...
        <input type="hidden" id="goods_carriage_carriageCount" value=""/>
          ...
          <div class="detail-adress"><span id="goods_carriage_carriagePrice" style="width:auto;"></span>
             ...
             <div>
                <p><a href="javascript:void(0);">免运费：0元</a></p>
                <p><a href="javascript:void(0);">EMS：10元</a></p>
              </div>
            </div>-->
          </div>
        </li>
      ...
      <ul class="specifications">
      	<#if data.saleAttrDicFormList??>
      		...
      		<li id="specifications-error0_${saleAttrDicForm_index+1}" >
		        ...
		        <label class="errorwrong" >请先选择商品属性</label> <div class="clear"></div>
	        </li>
      		</#list>
      	</#if>
...
<#-- 头部快捷栏出现时，点击购买，显示商品信息条  start -->
  <div class="good-tool" style="display: none;">
    <div class="good-tool-serch">
      ...
      <a href="javascript:void(0);" dm-actor="quick-gd-search">搜 索</a></div>
        ...
        <ul>
          ...
          <#if data.saleAttrDicFormList??>
          	<#list data.saleAttrDicFormList as saleAttrDicForm>
		          ...
		          <label class="errorwrong" style="display:none">请先选择商品属性</label> <div class="clear"></div>
		        </li>
          	</#list>
          </#if>
          <#--销售属性end -->
...
<script id="storeInfo" type="text/x-handlebars-template">
	...
	<img src="{{storeLogo}}" width="100" height="100" class="shop-header" /></a>-->
        <h3>
          <P>商铺等级</P>
          <img title="{{gradeId}}级商铺" src="${resources}/img/common/store{{gradeId}}.png"> </h3>
       <h4><a href="/fsst/{{storeId}}/top.jhtml" id="tjstoreName" data-sid="{{storeId}}">{{storeName}}</a></h4>
        ...
        <div class="shop-informaiton-bt"><a href="/fsst/{{storeId}}/top.jhtml" class=" small-button-greay m-r-10">进入商铺</a>
        <a href="javascript:void(0);" class=" small-button-greay" id="collect" onclick="addStoreFavorite()">收藏商铺</a></div>
</script>
<#--店铺详情模板 End-->
