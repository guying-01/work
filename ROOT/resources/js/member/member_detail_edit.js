	...
	$(document).ready(function(){
		var widthLi = $('#itemImgShop li').width();
		var clickNum = 0;

		$('.showPics .left').click(function () {
			if (clickNum >= 6) {
				return
			}
			movePic('#itemImgShop', 'left');
			clickNum++;
		});
		$('.showPics .right').click(function () {
			if (clickNum <= 0) {
				return
			}
			movePic('#itemImgShop', 'right');
			clickNum--;
		});
		$('.showPics .leftQ').click(function () {
			if (clickNum >= 6) {
				return
			}
			movePic('#itemImgQuality', 'left');
			clickNum++;
		});
		$('.showPics .rightQ').click(function () {
			if (clickNum <= 0) {
				return
			}
			movePic('#itemImgQuality', 'right');
			clickNum--;
		});
		function movePic(ele, position) {
	...
	function bigimg(obj){
		...
		$(".bigimg_up").find("p").append("<img src='"+url+"' width='300' height='300'>");
		$(".bigimg_up").fadeIn();
	}
