 ...
 * http://jqueryvalidation.org/ TODO 第五行兼容IE8修改了一段代码 a.data(b.form,"validator"):{"settings":""}
...
!function(a) {
    ...
    a.extend(a.fn, {validate: function(b) {
        ...
        return 1 === arguments.length ? function() {
        ...
        },messages: {required: "<div class='label-g'>必须填写</div>",remote: "请修正此栏位",email: "请输入有效的电子邮件",url: "请输入有效的网址",date: "请输入有效的日期",dateISO: "请输入有效的日期 (YYYY-MM-DD)",number: "请输入正确的数字",digits: "只可输入数字",creditcard: "请输入有效的信用卡号码",equalTo: "你的输入不相同",extension: "请输入有效的后缀",maxlength: a.validator.format("<div class='label-g'>最多{0}个字</div>"),minlength: a.validator.format("<div class='label-g'>最少{0}个字</div>"),rangelength: a.validator.format("请输入长度为 {0} 至 {1} 之間的字串"),range: a.validator.format("请输入 {0} 至 {1} 之间的数值"),max: a.validator.format("请输入不大于 {0} 的数值"),min: a.validator.format("请输入不小于 {0} 的数值")},autoCreateRanges: !1,prototype: {init: function() {
                function b(b) {
            ...
            var c = {}, d = a.data(b.form, "validator") ? a.data(b.form, "validator") : {"settings": ""};
            ...
            a.validator.methods[b] = c, a.validator.messages[b] = void 0 !== d ? d : a.validator.messages[b], c.length < 3 && a.validator.addClassRules(b, a.validator.normalizeRule(b))
                ...
                return this.optional(b) || /^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/.test(a)
            },url: function(a, b) {
